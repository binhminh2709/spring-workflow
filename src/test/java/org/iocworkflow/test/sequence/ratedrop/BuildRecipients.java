...
/**
 * Class:BuildRecipientsActivity Creation Date: Mar 12, 2005 CVS ID $Id:$
 *
 * Should be the first Activity executed during processing of the Airline Rate Drop workflow.  Seed data for the the rate drop should be present.
 *
 * @author sdodge
 * @since $Date:$
 */
